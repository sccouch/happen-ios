...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    NSString *requesterName = [source objectForKey:@"fullName"];
    
    // Configure the cell
    cell.textLabel.text = requesterName;
//    cell.detailTextLabel.text = [NSString stringWithFormat:@"Priority: %@", [object objectForKey:@"priority"]];
    
    
//    UIButton *acceptFriendRequestButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
//    HAPAcceptFriendButton *acceptFriendRequestButton = [[HAPAcceptFriendButton alloc] init];
...
//    acceptFriendRequestButton.frame = CGRectMake(200.0f, 5.0f, 75.0f, 30.0f);
    acceptFriendRequestButton.objectId = object.objectId;
